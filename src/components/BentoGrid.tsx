...
const projects: Project[] = [
  {
    ...
    description: "Predicts 10 fuel blend properties from 55 input features to optimize sustainable aviation fuel through mathematical models and prototypes.",
  ...
  },
  {
    id: "datavue",
    title: "DataVue",
    description: "Revolutionary ecosystem for data science with AI-powered EDA, dynamic visualizations, and a 24/7 AI assistant for learning and applying data science.",
  ...
  },
  {
    id: "infraseek360",
    title: "InfraSeek360",
    description: "Infrastructure-related search and analysis platform built with TypeScript for comprehensive infrastructure monitoring and insights.",
  ...
  },
  {
    ...
    description: "Toolcalling chatbot that interacts with database information and answers questions without hallucinations using advanced RAG techniques.",
    techStack: ["Jupyter", "LLM", "RAG", "Chatbot"],
    icon: MessageSquare,
    github: "https://github.com/safwanahmadsaffi",
    iconColor: "text-secondary",
  },
